            ...
            <div className="sm:w-10/12 lg:w-8/12">
              <div className="sm:px-16 lg:px-20">
                ...
                <p className="pt-6">
                  ...
                  graduado em administração e marketing. Ricardo Vale luta por
                  um Distrito Federal mais justo e inclusivo, e o gabinete 13
              ...
              <div className="pt-10 sm:px-16 lg:px-20">
                ...
                <div className="pt-12">
                  <p>
                    ...
                    com as atividades esportivas marcou a atuação do
                    parlamentar.
                  </p>
                  <p className="pt-6">
                    Durante seu mandato, Ricardo Vale destinou emendas para
                    áreas sociais, beneficiando, principalmente, a população da
                    periferia do DF. Além disso, foi o autor de importantes
                    regramentos, como a Lei que declarou o rock brasiliense como
                    patrimônio imaterial do DF; e a chamada Lei dos Boleiros,
                    que pretende transformar o fomento governamental do esporte
                    amador em política de Estado.
                  </p>
                  <p className="pt-6">
